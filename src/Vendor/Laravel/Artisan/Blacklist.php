...
class Blacklist extends Base {
	 ...
	 * @var string
	 */
	protected $name = 'steroids:blacklist';
	...
	{
		$type = $this->laravel->steroids->blacklist($this->argument('ip'), $this->option('force')) ? 'info' : 'error';

		$this->displayMessages($type, $this->laravel->steroids->getMessages());
	}
